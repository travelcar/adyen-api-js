...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenApiJs.ConfirmOrDeclineResult();
  });
  ...
  describe('ConfirmOrDeclineResult', function() {
    it('should create an instance of ConfirmOrDeclineResult', function() {
      // uncomment below and update the code to test ConfirmOrDeclineResult
      //var instane = new AdyenApiJs.ConfirmOrDeclineResult();
      //expect(instance).to.be.a(AdyenApiJs.ConfirmOrDeclineResult);
    });
