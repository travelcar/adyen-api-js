...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenApiJs.ConfirmOrDeclineRequest();
  });
  ...
  describe('ConfirmOrDeclineRequest', function() {
    it('should create an instance of ConfirmOrDeclineRequest', function() {
      // uncomment below and update the code to test ConfirmOrDeclineRequest
      //var instane = new AdyenApiJs.ConfirmOrDeclineRequest();
      //expect(instance).to.be.a(AdyenApiJs.ConfirmOrDeclineRequest);
    });
