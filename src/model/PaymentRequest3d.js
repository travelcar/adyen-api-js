...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/Amount', 'model/BrowserInfo', 'model/ForexQuote', 'model/Installments', 'model/Name', 'model/Recurring', 'model/ShopperInteraction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Address'), require('./Amount'), require('./BrowserInfo'), require('./ForexQuote'), require('./Installments'), require('./Name'), require('./Recurring'), require('./ShopperInteraction'));
  } else {
    // Browser globals (root is window)
    if (!root.AdyenApiJs) {
      root.AdyenApiJs = {};
    }
    root.AdyenApiJs.PaymentRequest3d = factory(root.AdyenApiJs.ApiClient, root.AdyenApiJs.Address, root.AdyenApiJs.Amount, root.AdyenApiJs.BrowserInfo, root.AdyenApiJs.ForexQuote, root.AdyenApiJs.Installments, root.AdyenApiJs.Name, root.AdyenApiJs.Recurring, root.AdyenApiJs.ShopperInteraction);
  }
}(this, function(ApiClient, Address, Amount, BrowserInfo, ForexQuote, Installments, Name, Recurring, ShopperInteraction) {
  'use strict';
   ...
   */
  exports.prototype['paResponse'] = undefined;
  /**
   ...
   * @return {String}
   */
  exports.prototype.getPaResponse = function() {
   ...
   */
  exports.prototype.setPaResponse = function(paResponse) {
