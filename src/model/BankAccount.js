...
(function(root, factory) {
   ...
   */
  var exports = function(iban, ownerName, countryCode) {
    var _this = this;
  ...
  /**
   * Returns the bank transit routing number
   * @return {String}
   */
  ...
  /**
   * Sets the bank transit routing number
   * @param {String} bankLocationId the bank transit routing number
   */
